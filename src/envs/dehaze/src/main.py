...
parser.add_argument(
    "--input", type=str, required=True, help="index for single input image"
)
parser.add_argument(
    "--t_min", type=float, default=0.25, help="minimum transmission rate"
)
parser.add_argument(
...
parser.add_argument(
    ...
    type=float,
    default=0.95,
    help="percantage of haze to be removed",
)
parser.add_argument(
    "--refine",
    type=bool,
